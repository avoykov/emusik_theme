...
To use these stylesheets, rename the files and bmc_theme with the name of your theme.
...
bmc_theme-alpha-default-narrow.css  
...
bmc_theme-alpha-default-normal.css
...
bmc_theme-alpha-default-wide.css
