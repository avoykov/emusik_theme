...
Drupal.theme.prototype.mkdruFacet = function (terms, facet, max, selections) {
  ...
  var tpl = '{{#terms}}<label><input type="checkbox" data-toggle="{{toggleLink}}" {{#selected}}checked="checked" {{/selected}}class="{{id}}"/>{{name}}</label> (<span class="facet-freq">{{freq}}</span>)</a>{{/terms}}';
